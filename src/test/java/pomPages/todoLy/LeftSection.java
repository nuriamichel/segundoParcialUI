...
public class LeftSection {
    ...
    public Button recycler = new Button(By.xpath("//td[@class=\"FilterItemContent\" and contains(.,'Recycle Bin')]"));
    public Button vaciar = new Button(By.xpath("//li[@class=\"delete\"]//a[@href=\"#emptyRecycle\"]"));
